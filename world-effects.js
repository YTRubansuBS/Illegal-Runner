(() => {
  ...
  const defs = {
    ...
    desert:{emoji:'🏜️',name:'DESERT',rarity:0,sky:['#4b1f45','#0c0716'],accent:'#ff8a3d',ground:'#160a12',coin:'#ffd84a',far:'#5a2748',mid:'#7a3355',theme:'desert'},
    ...
    sky:{emoji:'☁️',name:'SKY',rarity:0,sky:['#3978b9','#101b3d'],accent:'#e9f7ff',ground:'#111a2c',coin:'#fff2a6',far:'#4c8fc2',mid:'#6ab0e0',theme:'sky'},
    ...
    volcanic:{emoji:'🌋',name:'VOLCANIC',rarity:3,sky:['#5b1608','#110201'],accent:'#ff6b35',ground:'#100302',coin:'#ffd166',far:'#731d0b',mid:'#a72b0e',theme:'volcano'},
