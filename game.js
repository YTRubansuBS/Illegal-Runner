...
`)
  ...
  async function adminSearch() {`)
      ...
      code = code.replace('const t = pick(types)', 'const t = types[(window.__IR_BONUS_SPAWN_INDEX || 0) % types.length]; window.__IR_BONUS_SPAWN_INDEX = (window.__IR_BONUS_SPAWN_INDEX || 0) + 1')
